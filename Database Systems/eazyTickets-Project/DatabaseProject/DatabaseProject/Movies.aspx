      ...
      <div class="row">
        ...
        <div class="col-lg-3">
          ...
          <div class="list-group">
            <a href="Events.aspx" class="list-group-item" id="eventTab">Events</a>
            <a href="Concerts.aspx" class="list-group-item" id="concertTab">Concerts</a>
            <a href="#" class="list-group-item" id="movieTab">Movies</a>
          </div>
          ...
          <div id="carouselExampleIndicators" class="carousel slide my-4" data-ride="carousel">
            ...
            <div class="carousel-inner" role="listbox">
              <div class="carousel-item active">
                <img class="ip d-block img-fluid" src="images/movie1.jpg" alt="First slide">
              </div>
              <div class="carousel-item">
                <img class="ip d-block img-fluid" src="images/movie2.jpg" alt="Second slide">
              </div>
              <div class="carousel-item">
                <img class="ip d-block img-fluid" src="images/movie3.jpg" alt="Third slide">
              </div>
            </div>
            ...
            <br/>
       <asp:Repeater ID="Cinemas" OnItemDataBound="OnItemDataBound" runat="server">
           <HeaderTemplate>
                          </HeaderTemplate>
           <ItemTemplate>
               <h2><%# Eval("Name") %>,<%# Eval("Location") %></h2>
               ...
               <asp:Repeater ID="Display"  runat="server">
					        ...
					        <div class="col-lg-4 col-md-6 mb-4">
					          <div class="card h-100">
						        ...
						        <div class="card-body">
						          ...
						          <h5><%# Eval("cost") %> Rs</h5>
						          <p class="card-text">
                                      <strong>Date: </strong><small><%# Eval("date_time") %></small><br/>
                                      <strong>Cast: </strong><small><%# Eval("mainCast") %></small><br/>
                                      <strong>Director: </strong><small><%# Eval("director") %></small><br/>                                      
                                      <strong>Screen Type: </strong><small><%# Eval("ScreeningType") %></small><br/>                                      
						          </p>
						        </div>
                  ...
                  <asp:HiddenField ID="CinemaId" runat="server" Value='<%# Eval("CinemaId") %>' />
              </ItemTemplate>  
