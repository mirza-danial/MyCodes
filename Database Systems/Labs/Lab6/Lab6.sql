...
--3 Without VIEW
SELECT F2.FollowedUserName,COUNT(FollowerUserName) FOLLOWERS
FROM Following F2 
Group By FollowedUserName
Having COUNT(FollowerUserName)>All(
								SELECT Count(FollowerUserName) 
								FROM Following F3 
								WHERE F2.FollowedUserName !=F3.FollowedUserName
								Group By FollowedUserName
								)
